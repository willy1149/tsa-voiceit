...
ipcMain.on('update-custom-phrases', (event, phrases) => {
  if (overlayWindow) overlayWindow.webContents.send('update-custom-phrases', phrases);
});

ipcMain.on('update-common-phrases', (event, phrases) => {
  if (overlayWindow) overlayWindow.webContents.send('update-common-phrases', phrases);
});

ipcMain.on('update-phrases', (event, phrases) => {
  if (overlayWindow) overlayWindow.webContents.send('update-phrases', phrases);
});
